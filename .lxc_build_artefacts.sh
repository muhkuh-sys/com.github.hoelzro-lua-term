...
# Get all artifacts.
FILELIST=`lxc exec ${CONTAINER} -- bash -c 'find "/tmp/work" -path "/tmp/work/build/com.github.hoelzro-lua*-lua-term/targets/jonchki/repository/com/github/hoelzro/lua-term/*" -type f'`
echo ${FILELIST}
