...
lxc exec ${CONTAINER} -- bash -c 'tar --create --file /tmp/work/build/build_ubuntu_1704_x86_64_lua5.1.tar.gz --gzip --directory /tmp/work/build/linux/lua5.1/lua-term/install .'
lxc exec ${CONTAINER} -- bash -c 'tar --create --file /tmp/work/build/build_ubuntu_1704_x86_64_lua5.2.tar.gz --gzip --directory /tmp/work/build/linux/lua5.2/lua-term/install .'
lxc exec ${CONTAINER} -- bash -c 'tar --create --file /tmp/work/build/build_ubuntu_1704_x86_64_lua5.3.tar.gz --gzip --directory /tmp/work/build/linux/lua5.3/lua-term/install .'
